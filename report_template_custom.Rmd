...
knitr::kable(params$prcfiltered, 
             col.names = colnames(params$prcfiltered),  # Dynamically get the column names
             caption = "Filtered Data Used for PRC Calculation (Classification TRUE = Benign, FALSE = Pathogenic)")
